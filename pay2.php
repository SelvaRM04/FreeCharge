    ...
    <div class="container">
        <form method="post" id="form1">
            ...
            <div class="input-control">
                <label for="mob">Registered Mobile Number:
                <input type="text" id="mob" name="mn" value="<?php echo $regno ?>">
                </div>
                <div class="input-control">
                    <label for="Service Provider">Service Provider:
                        <input type="text" id="service" name="sp" value="<?php echo $service ?>">
                    </div>
                <div class="input-control">
