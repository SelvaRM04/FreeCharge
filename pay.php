    ...
    <div class="container">
        <form method="post" id="form1">
            ...
            <div class="input-control">
                ...
                <input type="text" id="mob" name="mn" value="<?php echo $rmn ?>">
                </div>
                <div class="input-control">
                    <label for="amt">Amount:</label><input type="text" id="amt" name="at" value="<?php echo $amt ?>"></div>
                <div class="input-control">
                    <label for="opt">Operator:</label><input type="text" id="opt" name="ot" value="<?php echo $operator ?>"></div>
                ...
                <div class="input-control" style="position:absolute;left:618px">
                    <label for="cvnu">CVV Number:</label><input type="tel" id="cvnu" name="cvvn" style="width:100px" ></div><div class="input-control" style="position: relative; top: 50px;">
                   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
